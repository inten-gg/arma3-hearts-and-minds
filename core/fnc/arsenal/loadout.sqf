...
private _cargo_uniform = [["acc_flashlight", 1], ["ACE_EarPlugs", 1], ["ACE_CableTie",5], ["ACE_MapTools", 1], ["ACE_RangeTable_82mm", 1]];
...
private _loadout = if (_isDay) then {
    [
        ...
        [_vest, []],
        _cargos select _type,
        _helmet,
        _hood,
        _binocular_array,
        ["ItemMap", "", _radio_item, "ItemCompass", "ChemicalDetector_01_watch_F", ""]
    ]
} else {
    [
        [],
        ...
        _hood,
        _binocular_array,
        ["ItemMap", "", _radio_item, "ItemCompass", "ChemicalDetector_01_watch_F", _night_vision]
    ]
};
